...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <div id="wrapper">
            ...
            <!-- Sidebar -->
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" data-toggle="collapse" id="accordionSidebar">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            ...
                            <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                    class="fas fa-download fa-sm text-white-50"></i> Generuj Raport</a>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class=" display col-lg-6 mb-4">
                                <div class=" col-lg-6 mb-4">
                                    <div class="card1 shadow mb-4">
                                        <div class="card-header2 shadow py-3 font-weight-bold h5-primary ">
