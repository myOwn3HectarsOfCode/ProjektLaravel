                ...
                <div class="container-fluid">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Zarobki (roczne)</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">215 000 zł</div>
                                        </div>
                                        <div class="col-auto">
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">Omówienie sprzedaży</h6>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Zestawiena i wybieranie danych do analizy</h6>
                                </div>
                                <div class="card-body">
                                    <p>Aplikacja pozwoli na wizualizację danych np. sprzedaz produktów z plików.</p>
                                    <p class="mb-0">Tu wkrótce pojawią się szvczegółowe instrukcje pracy z plikami.
                                        </p>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-7">
                                <div class="pad">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Chcesz się wylogować?</br></h1>
                                    </div>
